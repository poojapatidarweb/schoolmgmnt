...
ActiveRecord::Schema[7.1].define(version: 2023_12_02_183314) do
  ...
  create_table "student_curriculums", force: :cascade do |t|
    ...
    t.index ["curriculum_id"], name: "index_student_curriculums_on_curriculum_id"
    t.index ["student_id"], name: "index_student_curriculums_on_student_id"
  end

...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference("Datum.count") do
      post data_url, params: { datum: { description: @datum.description, name: @datum.name } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { description: @datum.description, name: @datum.name } }
